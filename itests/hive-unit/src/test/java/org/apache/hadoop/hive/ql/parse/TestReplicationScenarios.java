...
public class TestReplicationScenarios {
 ...
 static class Tuple {
  ...
  public void testCleanerThreadStartupWait() throws Exception {
    ...
    MetastoreConf.setTimeVar(newConf, REPL_EVENT_DB_LISTENER_TTL,EVENTS_TTL, TimeUnit.SECONDS);
    MetastoreConf.setTimeVar(newConf, EVENT_DB_LISTENER_CLEAN_STARTUP_WAIT_INTERVAL, EVENTS_TTL * 5, TimeUnit.SECONDS);
    MetastoreConf
    ...
    // Sleep for EVENTS_TTL time and see if events are there.
    Thread.sleep(EVENTS_TTL * 1000);
